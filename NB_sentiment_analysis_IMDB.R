...
# Remove sparse terms to reduce this high dimensionality (terms occurring in 20% retained)
...
# Wordcloud of most frequent words (found at least 1000 times in the training documents)
